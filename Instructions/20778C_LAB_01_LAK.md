...
4a. In the black navigation pane down the left side of the screen, click on **My Workspace** and then on **Reports**.  Click on the **Adventure Works Sales 1** report name to open it
